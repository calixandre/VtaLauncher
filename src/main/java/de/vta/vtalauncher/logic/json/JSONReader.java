package de.vta.vtalauncher.logic.json;
...
public class JSONReader {
    ...
    public static Profiles readProfiles(String minecraftDir) {
        ...
        if (minecraftDir == null) {
            LOGGER.info("Reading vtalauncher_profiles from: " + OSHelper.getMinecraftPath());
            path = OSHelper.getMinecraftPath();
            jsonObject = readJson(path + filename);
        } else {
            LOGGER.info("Reading vtalauncher_profiles from: " + minecraftDir);
