...
import de.vta.vtalauncher.exception.vtaVersionNotKnownException;
import de.vta.vtalauncher.logic.download.DownloadHelper;
import de.vta.vtalauncher.logic.download.DownloadUrls;
import de.vta.vtalauncher.logic.download.VersionLoader;
...
public class VersionListHelper {
    ...
    public void checkVersion(String version) throws vtaVersionNotKnownException {
        if (!versions.contains(version)) {
            throw new vtaVersionNotKnownException("Version: " + version);
        }
    }
