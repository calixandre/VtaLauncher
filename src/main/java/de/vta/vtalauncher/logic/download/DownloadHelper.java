...
public class DownloadHelper {
     ...
     * @param file
     * @return
     * @throws vtaDownloadException
     */
    public static String downloadFileToDiskWithCheck(String url, String file) throws VtaDownloadException {
     ...
     * @throws VTADownloadException
     */
    public static String downloadFileToDiskWithoutCheck(String url, String file) throwsVTADownloadException {
        FileHelper helper = new FileHelper(url, file);
    ...
    public static String downloadFileToDiskWithCheck(String fAddress, String destinationDir,
                                                     String myFileName) throws VtaDownloadException {
     ...
     * @throws vtaDownloadException
     */
    private static String downloadFileToDisk(FileHelper fileHelper, boolean shouldCheck) throws VtaDownloadException {
        ...
        if (shouldFileBeDownloaded(fileHelper, shouldCheck)) {
            ...
            if (lastPeriodIndex >= 1 && lastSlashIndex >= 0
                ...
                try {
                    ...
                    throw new VtaDownloadException("Exception occured while downloading from " + fAddress, e);
                }
