...
import de.vta.vtalauncher.logic.LogicController;
import de.vta.vtalauncher.logic.json.JSONWriter;
...
public class AuthenticationServiceTest {
    ...
    public void deleteProfiles() {
        File login = new File(OSHelper.getMinecraftPath() + "vtalauncher_profiles.json");
    ...
    public void testGetUsersAfterNewGetSessionID() throws vtaException {
        givenNewAuthService();
    ...
    private void givenNewAuthService() throws vtaException {
        expected = new ArrayList<MinecraftUser>();
