...
import de.vta.vtalauncher.logic.download.loader.JarDownloader;
import de.vta.vtalauncher.logic.download.loader.LibraryDownloader;
import de.vta.vtalauncher.logic.download.loader.RessourceDownloader;
import de.vta.vtalauncher.logic.download.loader.SkinDownloader;
...
import de.vta.vtanlauncher.logic.vm.SkinVM;
...
public class DownloadService implements Runnable {
    ...
    public void setMinecraftVersion(MinecraftVersion version, String assetsVersion) throws VtaLogicException {
        try {
            ...
            throw new VtaDownloadException("Could not download Json File: " + version.getVersion() + ".json");
        }

        this.mCurrentVersion = version;
    }

    public void setMinecraftVersion(MinecraftVersion version) throws VtaLogicException {
